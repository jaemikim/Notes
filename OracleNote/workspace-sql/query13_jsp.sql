...
UPDATE MVCBOARD  SET VISITCOUNT = VISITCOUNT + 1 WHERE id = '264';   -- 264(id) 카운트 1증가  

UPDATE MVCBOARD SET DOWUNCOUNT = DOWUNCOUNT  + 1 WHERE ID  = '266';  -- 다운카운트 증가

SELECT COUNT(*) FROM MVCBOARD WHERE pass = '1234' AND id = '266'; 

DELETE FROM MVCBOARD WHERE id = '259';
ROLLBACK;
